...
export default function ProjectCard({ project }) {
  return (
    <div className="grid lg:grid-cols-2 bg-black/30 gap-10 items-center rounded-xl border border-white/20 overflow-hidden">

      {/* Left Content */}
      <div className="p-8">
        <span className="inline-block mb-3 py-1 px-3 rounded-full text-xs font-semibold bg-[#31572C]/10 text-[#31572C]">
          {project.category}
        </span>
        ...
        <ul className="space-y-2 text-sm mb-6 list-disc pl-5 marker:text-[#31572C] text-zinc-300">
          <li>
